...
async function main() {
  ...
  if (fs.existsSync(dbPath)) {
    try {
      ...
      const scanners = ['aave-v3', 'morpho', 'euler2', 'fluid-lending', 'fluid-vault', 'spark-savings', 'spark-lend', 'pendle-pt', 'pendle-yt', 'pendle-lp', 'vault', 'vault-probed', 'ybs', 'wallet-held', 'ethena-cooldown', 'yo-protocol', 'compound3', 'curve'];
